...
- `VITE_ONE_TIME_CLOUD_CHECKOUT_ENABLED` — defaults to `false`; the account starts checkout only when this flag, the shared source catalog, and the matching server-side gate are all explicitly open
